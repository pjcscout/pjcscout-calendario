// Calcula minutos jugados por convocado de jornada 2 en DH7, a partir de las
...
writeFileSync('scripts/scraper/salida-minutos-dh7-j2.json', JSON.stringify(MINUTOS, null, 2))
