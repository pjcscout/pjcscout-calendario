// Calcula los minutos jugados por cada convocado de jornada 3 en las 7
...
writeFileSync('scripts/scraper/salida-minutos-ffcv-j3.json', JSON.stringify(MINUTOS, null, 2))
