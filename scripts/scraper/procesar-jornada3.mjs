// Script local (no CI): procesa jornada3-detalle.json y genera las entradas
...
const JORNADA = 3
const { resultadoFinal } = JSON.parse(readFileSync('jornada3-detalle.json', 'utf8'))
...
writeFileSync('scripts/scraper/salida-eventos-j3.json', JSON.stringify(nuevasEntradas, null, 2))
writeFileSync('scripts/scraper/salida-convocatorias-j3.json', JSON.stringify(convocatoriasVolcado, null, 2))
