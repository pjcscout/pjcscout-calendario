// Calcula los minutos jugados por cada convocado de la jornada N (env
// JORNADA) en las 7 categorías FFCV, a partir de las alineaciones
// (titulares+suplentes con dorsal) y las sustituciones (entra/sale con
// dorsal y minuto) ya scrapeadas en jornada<N>-detalle.json.
...
writeFileSync(`scripts/scraper/salida-minutos-ffcv-j${JORNADA}.json`, JSON.stringify(MINUTOS, null, 2))
