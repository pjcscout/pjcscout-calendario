...
//
// Jornadas acumuladas hasta ahora: 1 a ${JORNADA}. Cuando se añadan más hay que
// sumar los minutos nuevos a los que ya hubiera aquí, no sustituirlos.
//
...
console.log('minutosJugados.js actualizado con', Object.keys(total).length, 'equipos (jornadas 1 a', JORNADA, 'acumuladas)')
