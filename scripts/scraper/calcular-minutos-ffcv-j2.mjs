// Calcula los minutos jugados por cada convocado de jornada 2 en las 7
...
writeFileSync('scripts/scraper/salida-minutos-ffcv-j2.json', JSON.stringify(MINUTOS, null, 2))
