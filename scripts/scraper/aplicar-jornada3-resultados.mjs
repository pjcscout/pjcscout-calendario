// Añade las entradas RESULTADOS de jornada 3 (FFCV + DH7) a resultados.js,
// sin tocar las de jornada 1 que ya había.
import { readFileSync, writeFileSync } from 'node:fs'

const eventosFfcv = JSON.parse(readFileSync('scripts/scraper/salida-eventos-j3.json', 'utf8'))
const eventosDh7 = JSON.parse(readFileSync('scripts/scraper/salida-dh7-eventos-j3.json', 'utf8'))
...
console.log('Añadidas', nuevasLineas.length, 'entradas de jornada 3 a resultados.js')
