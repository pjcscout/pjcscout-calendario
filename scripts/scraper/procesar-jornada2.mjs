// Script local (no CI): procesa jornada2-detalle.json y genera las entradas
// RESULTADOS de jornada 2 con eventos reales (gol, tarjeta_amarilla,
// tarjeta_roja) + el portero titular de cada equipo, listas para fusionar
// en resultados.js. Mismo criterio que procesar-jornada1.mjs.
import { readFileSync, writeFileSync } from 'node:fs'
import { equiposPorGrupo } from '../../src/data/equipos.js'
import { idPartido } from '../../src/data/resultados.js'

const JORNADA = 2
const { resultadoFinal } = JSON.parse(readFileSync('jornada2-detalle.json', 'utf8'))
...
writeFileSync('scripts/scraper/salida-eventos-j2.json', JSON.stringify(nuevasEntradas, null, 2))
writeFileSync('scripts/scraper/salida-convocatorias-j2.json', JSON.stringify(convocatoriasVolcado, null, 2))
