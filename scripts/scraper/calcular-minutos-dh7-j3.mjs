// Calcula minutos jugados por convocado de jornada 3 en DH7, a partir de las
...
writeFileSync('scripts/scraper/salida-minutos-dh7-j3.json', JSON.stringify(MINUTOS, null, 2))
console.log('Equipos con minutos DH7 jornada 2:', Object.keys(MINUTOS).length, '/ 16')
