// Suma los minutos de jornada 2 (FFCV + DH7) a los que ya hubiera en
...
const nuevosFfcv = JSON.parse(readFileSync('scripts/scraper/salida-minutos-ffcv-j2.json', 'utf8'))
const nuevosDh7 = JSON.parse(readFileSync('scripts/scraper/salida-minutos-dh7-j2.json', 'utf8'))
...
console.log('minutosJugados.js actualizado con', Object.keys(total).length, 'equipos (jornada 1 + jornada 2 acumuladas)')
