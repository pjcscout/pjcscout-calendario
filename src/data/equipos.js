...
export const EQUIPOS = [
  ...
  { id: "llcsud-redovan-a", nombre: "F.B. Redován C.F. \"A\"", grupo: "llc-sud", localidad: "Redován", color: "#0A5FA8" },
  { id: "llcsud-olimpic", nombre: "C.D. Olímpic", grupo: "llc-sud", localidad: "Xàtiva", color: "#FBF8EF" },
  { id: "llcsud-tavernes-valldigna", nombre: "C.F.U.E. Tavernes de la Valldigna", grupo: "llc-sud", localidad: "Tavernes De La Valldigna", color: "#C81E2C" },
  { id: "llcsud-alberic", nombre: "C.E. Alberic Sucemart", grupo: "llc-sud", localidad: "Alberic", color: "#FBF8EF" },
  { id: "llcsud-javea", nombre: "C.D.F. Jávea", grupo: "llc-sud", localidad: "Jávea", color: "#C81E2C" },
  ...
  { id: "llcsud-santa-pola", nombre: "Santa Pola C.F.", grupo: "llc-sud", localidad: "Santa Pola", color: "#C81E2C" },
  ...
  { id: "llcsud-rayo-ibense-a", nombre: "U.D. Rayo Ibense \"A\"", grupo: "llc-sud", localidad: "Ibi", color: "#C81E2C" },
  ...
  { id: "llcnord-alqueries-a", nombre: "Alqueries C.F. \"A\"", grupo: "llc-nord", localidad: "Alquerías Del Niño Perdido", color: "#F7D117" },
  ...
  { id: "llcnord-burriana-a", nombre: "C.D. Burriana \"A\"", grupo: "llc-nord", localidad: "Burriana", color: "#0A5FA8" },
